...
{
	uint8_t txData[2]={LIS3DSH_REG4_REG,0x55};
	uint8_t rxData[2]={0x00,0x00};
	SPI_Read(txData, rxData, 2);
...
{
	uint8_t txData[2]={LIS3DSH_WHOAMI_REG,0x55};
	uint8_t rxData[2]={0x00,0x00};
	SPI_Read(txData, rxData, 2);
...
/*
	uint8_t txData3[2]={LIS3DSH_REG3_REG,0xC8};
...
{
	uint8_t txData[]={LIS3DSH_REG3_REG,0xC8};
...
{
	uint8_t txData[]={LIS3DSH_OUT_T_REG};
	uint8_t rxData[]={0x00};
...
{
	uint8_t txData[2]={LIS3DSH_OUT_Z_L_REG,0x55};
	uint8_t rxData[2]={0xba,0xbe};
	SPI_Read(txData, rxData, 2);
...
{
	uint8_t txData[]={LIS3DSH_OUT_Z_H_REG,0x55};
	uint8_t rxData[]={0xba,0xbe};
	SPI_Read(txData, rxData, 2);
...
{
	uint8_t txData[]={LIS3DSH_STATUS_REG,0x55};
	uint8_t rxData[]={0x00,0x00};
	SPI_Write(txData, rxData, 2);
