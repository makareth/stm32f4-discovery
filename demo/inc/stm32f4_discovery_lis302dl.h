...
#define LIS302DL_SPI_SCK_PIN               GPIO_PIN_3                  /* PA.05 */
...
// SCO
#define LIS302DL_CS_LOW()       HAL_GPIO_WritePin (LIS302DL_SPI_CS_GPIO_PORT, LIS302DL_SPI_CS_PIN, GPIO_PIN_RESET);
#define LIS302DL_CS_HIGH()      HAL_GPIO_WritePin (LIS302DL_SPI_CS_GPIO_PORT, LIS302DL_SPI_CS_PIN, GPIO_PIN_SET);
/**
  * @}
  */ 
